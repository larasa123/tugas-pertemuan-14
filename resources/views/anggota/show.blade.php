            ...
            <div class="card-body">
                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>: {{ \Carbon\Carbon::parse($anggota->tanggal_daftar)->format('d F Y') }}</td>
                    </tr>
                </table>
                ...
                <div class="row text-muted small">
                    <div class="col-md-6">
                        <i class="bi bi-clock"></i> 
                         Ditambahkan: {{ \Carbon\Carbon::parse($anggota->created_at)->format('d M Y H:i') }}
                    </div>

                    <div class="col-md-6 text-end">
                        <i class="bi bi-clock-history"></i> 
                        Terakhir Update: {{ \Carbon\Carbon::parse($anggota->updated_at)->format('d M Y H:i') }}
                    </div>
                </div>
            </div>
        </div>
